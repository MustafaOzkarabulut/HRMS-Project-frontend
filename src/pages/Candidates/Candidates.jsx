...
export default function Candidates() {
    ...
    return (
        <div  className="container">
            ...
            <div className="candidatesbox" key={candidates.id}>
                <Logo className="companyimage"/>
                <h4>{candidates.education.sectionName}</h4>
                <div className="inf-box-top city"><i className="fas fa-university"></i>{candidates.education.schoolName}</div>
                ...
                <div className="inf-box-bottom-left linkedin"><i class="fab fa-linkedin"></i>LinkedIn</div>
            </div>
